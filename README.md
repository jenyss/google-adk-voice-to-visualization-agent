...
This project is a voice-powered AI agent built with Google ADK. You just say what kind of chart or analysis you need like “Show a bar chart of forecast by channel”, and the agent takes care of the rest: transcribes your voice, understands the request, queries your Excel data with DuckDB, and shows the result as an interactive Plotly visualization.
